...
graph_partition_tuples.append(
    (graph1, initial_partitions[len(graph1.nodes())])
)
...
graph_partition_tuples.append(
    (graph2, initial_partitions[len(graph2.nodes())])
)

# 3
graph3 = rx.PyDiGraph()
graph3.add_nodes_from(range(10))
graph3.add_edges_from_no_data(
    [
        (0, 2),
        (0, 3),
        (0, 5),
...
graph_partition_tuples.append(
    (graph3, initial_partitions[len(graph3.nodes())])
)
...
graph_partition_tuples.append(
    (graph4, initial_partitions[len(graph4.nodes())])
)
...
graph_partition_tuples.append(
    (graph5, initial_partitions[len(graph5.nodes())])
)
...
graph_partition_tuples.append(
    (graph6, initial_partitions[len(graph6.nodes())])
)
...
graph_partition_tuples.append(
    (graph7, initial_partitions[len(graph7.nodes())])
)

# 8
graph8 = rx.PyDiGraph()
graph8.add_nodes_from(range(5))
graph8.add_edges_from_no_data(
    [
        (0, 2),
        (0, 3),
        (1, 2),
...
graph_partition_tuples.append(
    (graph8, initial_partitions[len(graph8.nodes())])
)

# 9
graph9 = rx.PyDiGraph()
graph9.add_nodes_from(range(3))
graph9.add_edges_from_no_data([(0, 1), (0, 2), (1, 0), (2, 0), (2, 1)])
graph_partition_tuples.append(
    (graph9, initial_partitions[len(graph9.nodes())])
)

# 10
graph10 = rx.PyDiGraph()
graph10.add_nodes_from(range(3))
graph10.add_edges_from_no_data([(0, 1), (0, 2), (1, 0), (1, 2)])
graph_partition_tuples.append(
    (graph10, initial_partitions[len(graph10.nodes())])
)

# 11
graph11 = rx.PyDiGraph()
graph11.add_nodes_from(range(3))
graph11.add_edges_from_no_data([(0, 1), (1, 2), (2, 0), (2, 1)])
graph_partition_tuples.append(
    (graph11, initial_partitions[len(graph11.nodes())])
)

# 12
graph12 = rx.PyDiGraph()
graph12.add_nodes_from(range(3))
graph12.add_edges_from_no_data(
...
graph.add_edges_from_no_data([(0, 2), (0, 3), (1, 2), (2, 4), (3, 4)])
...
graph = rx.PyDiGraph()
graph.add_nodes_from(range(9))
graph.add_edges_from_no_data([(0, 4), (0, 7), (5, 7), (6, 8)])
graph_partition_rscp_tuples.append(
    (
        graph,
        [(2,), (3,), (0, 4), (5,), (1, 7), (6, 8)],
...
graph = rx.PyDiGraph()
graph.add_nodes_from(range(5))
graph.add_edges_from_no_data([(0, 1), (1, 2), (2, 3), (3, 4), (4, 0)])
graph_partition_rscp_tuples.append(
    (
        graph,
        [(4,), (0, 1, 2, 3)],
...
graph = rx.PyDiGraph()
graph.add_nodes_from(range(5))
graph.add_edges_from_no_data([(0, 1), (1, 2), (2, 3), (3, 0), (0, 4)])
graph_partition_rscp_tuples.append(
    (
        graph,
        [(0, 1, 2, 3, 4)],
...
graph = rx.PyDiGraph()
graph.add_nodes_from(range(5))
graph.add_edges_from_no_data([(0, 1), (1, 2), (2, 3), (3, 4), (4, 0), (2, 4)])
graph_partition_rscp_tuples.append(
    (
        graph,
        [(0, 1, 2, 3, 4)],
...
graph = rx.PyDiGraph()
graph.add_nodes_from(range(5))
graph.add_edges_from_no_data([(0, 1), (1, 3), (3, 4), (4, 3), (0, 4), (2, 4)])
graph_partition_rscp_tuples.append(
    (
        graph,
        [(0, 1, 2), (3, 4)],
